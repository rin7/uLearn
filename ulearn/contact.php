...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/home_s.gif','images/about_s.gif','images/schedule_s.gif','images/contact_s.gif','images/help_s.gif','images/contact.gif')">
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461"> <h1 class="style3">Contact Us: </h1>
                  <p align="justify"> If you have any question and want to contact with please send an email just click on this link. <a href="mailto:arin@gmail.com">arin@gmail.com</a></p>
                  <p align="justify">If you are already member please<em> login</em>.</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p></td>
                <td width="15">&nbsp;</td>
          ...
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            ...
            <form action="<?php echo $loginFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('username','','R','password','','R');return document.MM_returnValue">
              <table width="100%"  border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td width="42%" align="right"><span class="style5">User Name:</span></td>
                  <td width="43%"><input name="username" type="text" id="username" size="12" ></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
