        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style8">Dear Faculty,<?php echo $_SESSION['MM_Username'] ?>:</h1>
                  <p align="justify" class="style8">-<span class="style9">Its your home page.Now you can edit your profile, add student, add faculty, add new course,search for student list, edit student profile and history by select from menu on the right side.</span></p>
                  <p class="style8">&nbsp;</p>
                  <p class="style8">&nbsp;</p>
                  <p>&nbsp; </p>
                <p>&nbsp;</p></td>
