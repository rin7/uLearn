...
.style19 {font-size: 14px; color: #FFFFFF; font-style: italic; }
.style3 {color: #658393; }
-->
</style>
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/home_s.gif','images/about_s.gif','images/schedule_s.gif','images/contact_s.gif','images/help_s.gif','images/about.gif','images/shelp_s.gif')">
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style3">About Us: </h1>
                  <p align="justify"> APTECH School automate the Student Information System. They have named as &ldquo;ULearn&rdquo; program, this is the new way.We hope to prepare a way for every one from every place how want to study come and join us thats is simly way for each student to access via internet to change submit his favorite course and register and set his schedule and finaly see the result contact directly with faculty easily and find his question answer.</p>                  
                  <h1 class="style8">&nbsp;</h1>
                  <p>&nbsp; </p>
                <p>&nbsp;</p></td>
                <td width="15">&nbsp;</td>
          ...
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            <table width="100%"  border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="center" valign="top"><span class="style17"><span class="style8"><span class="style19"><?php echo $_SESSION['MM_Username'] ?></span></span></span></td>
