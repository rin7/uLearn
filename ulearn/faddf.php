...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form2")) {
  $insertSQL = sprintf("INSERT INTO faculty (FName, LName, Gender, SSN, Address, Tel, EMail, FUserName, Password) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
mysql_select_db($database_connection, $connection);
$query_Recordset1 = "SELECT faculty.FUserName, faculty.FName, faculty.LName, faculty.Tel, faculty.EMail FROM faculty";
...
.style24 {color: #658393; font-size: 14px; }
-->
</style>
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br>
            <table width="460" border="0" cellspacing="0">
              <tr>
                <td width="461"><h1 class="style8">Search &amp; Add Faculty :</h1>
                  <table width="100%" border="1" cellpadding="1" cellspacing="1">
                    <tr class="style2">
                      <td width="70" align="center"><span class="style24">Faculty User Name:</span></td>
                      <td width="130" align="center"><span class="style24">Faculty Name</span></td>
                      <td width="20" align="center"><span class="style24">Telephone No.</span></td>
                      <td width="90" align="center"><span class="style24">EMail Address:</span></td>
                    </tr>
                    <?php do { ?>
                    <tr>
                      <td align="center"><?php echo $row_Recordset1['FUserName']; ?></td>
                      <td align="center"><?php echo $row_Recordset1['FName']; ?><?php echo $row_Recordset1['LName']; ?></td>
                      <td align="center"><?php echo $row_Recordset1['Tel']; ?></td>
                      <td align="center"><a href="mailto:<?php echo $row_Recordset1['EMail']; ?>" class="style9"><?php echo $row_Recordset1['EMail']; ?></a></td>
                    </tr>
                    <?php } while ($row_Recordset1 = mysql_fetch_assoc($Recordset1)); ?>
                  </table>
                  <table width="113%"  border="0" cellspacing="0" cellpadding="1">
                    <tr>
                  ...
                  <form action="<?php echo $editFormAction; ?>" method="POST" name="form2" onSubmit="MM_validateForm('UserName','','R','fname','','R','lname','','R','ssn','','RisNum','email','','RisEmail','tel','','RisNum','paddress','','R','password','','R','cpassword','','R');return document.MM_returnValue">
                      <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                        <tr>
                          <td width="2%">&nbsp;</td>
                          <td colspan="3" align="right"><div align="left">-<span class="style9">Please fill this form carefully for add new faculty:</span></div></td>
                          <td width="16%">&nbsp;</td>
                          <td width="5%">&nbsp;</td>
                        </tr>
                        <tr>
                          ...
                          <td width="16%"><span class="style10 style12">*Required</span></td>
                          <td width="5%">&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                          ...
                          <td><span class="style22">*Required</span></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td valign="top"><span class="style22">*Required</span></td>
                          <td>&nbsp;</td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        ...
                        <tr>
                          ...
                          <td><input name="Submit" type="submit" onClick="MM_validateForm('UserName','','R','ssn','','RisNum','email','','RisEmail','tel','','RisNum','password','','R','cpassword','','R');return document.MM_returnValue" value="Register"></td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
                        </tr>
                      </table>
