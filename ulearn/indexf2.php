                ...
                <td width="461" valign="top"> <h1 class="style3 style11">Faculty Login: </h1>
                    ...
                    <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td width="25%"><input name="Submit" type="submit" onClick="MM_validateForm('username','','R','password','','R');return document.MM_returnValue" value="Sign In"></td>
                        <td width="22%">&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td colspan="3"><span class="style16">*Please check your User Name &amp; Password </span></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
