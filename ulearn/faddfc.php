        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style8">Add Faculty Completed :<span class="style16"><span class="style8"></span></span></h1>
                  <p class="style8">-<span class="style9">New Faculty added successfully.</span> </p>
                  <p>&nbsp;</p></td>
                <td width="15">&nbsp;</td>
              </tr>
          </table></td>
