...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/home_s.gif','images/about_s.gif','images/schedule_s.gif','images/contact_s.gif','images/help_s.gif','images/about.gif')">
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461"> <h1 class="style3">About Us: </h1>
                  <p align="justify"> APTECH School automate the Student Information System. 
                  They have named  as &ldquo;ULearn&rdquo; program, this is the new way.We hope to prepare a way for every one from every place how want to study come and join us thats is simly way for each student to access via internet to change submit his favorite course and register and set his schedule and finaly see the result contact directly with faculty easily and find his question answer.So you can join to this system just fill the registeration form by just sign in link on the right side of the page or <a href="register.php" class="style3">click here</a>.for further information plesase contact with us or see the help page.</p>
                  <p>&nbsp;</p></td>
                <td width="15">&nbsp;</td>
              </tr>
          </table></td>
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            ...
            <form name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
              <table width="100%"  border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td width="41%" align="right"><span class="style5">User Name:</span></td>
                  <td width="47%"><input name="username" type="text" id="username" size="12" ></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="2"><p align="justify"><span class="style5">*Not a member<span class="style7"> <a href="register.php" title="Sign Up">Click here</a></span></span><span class="style5"> to register and create your personal account.</span></p>
                  </td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="2"><p><a href="indexf.php">Faculty Login Click Here</a></p>
                  <p>&nbsp;</p></td>
                  <td>&nbsp;</td>
                </tr>
              </table>
