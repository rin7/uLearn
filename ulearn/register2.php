...
.style6 {color: #658393; font-size: 24px; }
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461"> <h1 class="style6">Registeration Completed successfully:</h1>
                  <p> Thank you , now you can sign in with your user name and password.</p>
                  <p>&nbsp;</p>
                  <p>&nbsp;</p>
          ...
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            ...
            <form name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
              <table width="100%"  border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="2"><span class="style10">Students Login:</span></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
