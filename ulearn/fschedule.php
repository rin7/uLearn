        ...
        <tr> 
            ...
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461"> <h1 class="style3">Course Schedule: </h1>
                  <p align="justify" class="style3"> Dear faculty As you can see this the list of available cousre You can add new course by selecting add course link from your main menu.<br>
                  </p>
                  <form name="form2" method="post" action="">
                    <table border="1" cellpadding="1" cellspacing="1">
                      <tr>
                        <td width="60"><div align="center"><span class="style9">Course Name: </span></div></td>
                        <td width="100"><div align="center"><span class="style9">Faculty Name: </span></div></td>
                        <td width="240"><span class="style9">Course Details: </span></td>
                      </tr>
                      <?php do { ?>
                      <tr>
                  ...
                  <table width="100%"  border="0" cellspacing="0" cellpadding="1">
                    <tr>
                      ...
                      <td align="center" valign="top">&nbsp; Records <?php echo ($startRow_Recordset1 + 1) ?> to <?php echo min($startRow_Recordset1 + $maxRows_Recordset1, $totalRows_Recordset1) ?> of <?php echo $totalRows_Recordset1 ?> </td>
                    </tr>
                  </table>                  <p>&nbsp;</p>
                  <p>&nbsp;</p></td>
                <td width="15">&nbsp;</td>
          ...
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            <table width="100%"  border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="center" valign="top"><span class="style17"><span class="style22"><a href="<?php echo $logoutAction ?>" class="style16">Sign Out</a>:</span></span></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
