...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE studenthistory SET UME=%s, DegreeSought=%s, AdditionalDegree=%s, CurrentClassification=%s, `Catalog`=%s, CertificationSought=%s, FSE=%s, LSE=%s, LReason=%s WHERE SUserName=%s",
...
if (isset($_GET['SUserName'])) {
  $colname_Recordset1 = (get_magic_quotes_gpc()) ? $_GET['SUserName'] : addslashes($_GET['SUserName']);
}
mysql_select_db($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT SUserName, UME, DegreeSought, AdditionalDegree, CurrentClassification, `Catalog`, CertificationSought, FSE, LSE, LReason FROM studenthistory WHERE SUserName = '%s'", $colname_Recordset1);
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style8">Edit Student's History:<br>
                    <span class="style32"><em>-</em>Now you can edit student history:</span><br>
                    <span class="style29">*Remember you can just edit students that have recorded history before!but if you want add history go add student and then selest add students history. </span> 
                    </h1>
                  <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                    <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td colspan="2"><label><?php echo $row_Recordset1['SUserName']; ?></label></td>
                        <td width="14%"><span class="style12"></span></td>
                        <td width="5%"><input name="hiddenField" type="hidden" value="<?php echo $row_Recordset1['SUserName']; ?>"></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                        <td width="43%" align="right"><span class="style12 style12">ULearn Mode of Entry:</span></td>
                        <td colspan="2"><input name="UME" type="text" id="UME" value="<?php echo $row_Recordset1['UME']; ?>"></td>
                      ...
                      <tr>
                        ...
                        <td colspan="2"><input name="DegreeSought" type="text" id="DegreeSought" value="<?php echo $row_Recordset1['DegreeSought']; ?>"></td>
                      ...
                      <tr>
                        ...
                        <td colspan="2"><input name="AdditionalDegree" type="text" id="AdditionalDegree" value="<?php echo $row_Recordset1['AdditionalDegree']; ?>"></td>
                        <td><span class="style29">*Required</span></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2"><input name="CurrentClassification" type="text" id="CurrentClassification" value="<?php echo $row_Recordset1['CurrentClassification']; ?>"></td>
                        <td><span class="style29">*Required</span></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2"><span class="style12">
                          <input name="catalog" type="text" id="catalog" value="<?php echo $row_Recordset1['Catalog']; ?>">
                          <label></label>
                        </span></td>
                        <td><span class="style29">*Required</span></td>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td colspan="2"><input name="CertificationSought" type="text" id="CertificationSought" value="<?php echo $row_Recordset1['CertificationSought']; ?>"></td>
                        <td><span class="style29">*Required</span></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2"><input name="FSE" type="text" id="FSE" value="<?php echo $row_Recordset1['FSE']; ?>"></td>
                      ...
                      <tr>
                        ...
                        <td colspan="2"><input name="LSE" type="text" id="LSE" value="<?php echo $row_Recordset1['LSE']; ?>"></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td align="right"><span class="style12">Reason for Leaving ULearn: </span></td>
                        <td colspan="2"><input name="LReason" type="text" id="LReason" value="<?php echo $row_Recordset1['LReason']; ?>"></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
