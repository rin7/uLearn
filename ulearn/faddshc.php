        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style8">Student's History completed:<span class="style16"><span class="style8"></span></span></h1>
                  <p align="justify" class="style8">-<span class="style9">New Student's history added successfully you can edit it later from search &amp; edit student option from main menu.</span></p>
                  <p>&nbsp; </p>
                <p>&nbsp;</p></td>
                <td width="15">&nbsp;</td>
              </tr>
