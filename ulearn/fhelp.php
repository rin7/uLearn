            ...
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style3">Help &amp; FAQ: </h1>
                  <p align="justify"> APTECH School automate the Student Information System. They have named as &ldquo;ULearn&rdquo; program, this is the new way to learn.<br>
                    Dear faculty as you can see you can 
                  use your main menu option to edit your profile, add student, add faculty, search &amp; add course, search student and edit the details just select from menu.</p>
                  <h1 class="style8">&nbsp;</h1>
