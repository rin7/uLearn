...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" onLoad="MM_preloadImages('images/home_s.gif','images/about_s.gif','images/schedule_s.gif','images/contact_s.gif','images/help_s.gif','images/help.gif')">
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461"> <h1 class="style3">Help &amp; FAQ: </h1>
                  <p align="justify"> APTECH School automate the Student Information System. 
                  They have named  as &ldquo;ULearn&rdquo; program, this is the new way to learn, if you want to be a member please and register from anywhere just conect to our website with your computer and see the schedule submit edit and find out more information about any course.But first of all you have to register to be as a new member, its soeasy and u have fill the eregistration form and submit it as you can see the link on the right side of the page or <a href="register.php" class="style3">click here</a>.for further information plesase contact with us.</p>
                  <p align="justify">If you are already member please<em> login </em>by enter your username and password and sign in after that you can edit your profile or select a course.</p>
                  <p>&nbsp;</p></td>
                <td width="15">&nbsp;</td>
              </tr>
          </table></td>
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            ...
            <form action="<?php echo $loginFormAction; ?>" method="POST" name="form1" onSubmit="MM_validateForm('username','','R','password','','R');return document.MM_returnValue">
              <table width="100%"  border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  ...
                  <td width="42%"><input name="username" type="text" id="username" size="12" ></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td colspan="2"><div align="justify"><span class="style5">*Not a member<span class="style7"> <a href="register.php" title="Sign Up">Click here</a></span></span><span class="style5"> to register and create your personal account.</span></div></td>
                  <td>&nbsp;</td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
