        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br>
            <table width="460" border="0" cellspacing="0">
              <tr>
                <td width="461"><h1 class="style8">Add Student :</h1>
                    <p align="justify" class="style8">-<span class="style9">Please fill this form carefully, we need your information in near futher:<br>
                      -You can add <strong>student's history</strong> by selecting from menu or <a href="faddsh.php">click here.</a> </span></p>
          ...
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            <table width="100%"  border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="center" valign="middle"><a href="faddsh.php" class="style15">Add Students History </a></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
