...
mysql_select_db($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM students WHERE SUserName = '%s'", $colname_Recordset1);
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style8">Edit Profile: <?php echo $_SESSION['MM_Username'] ?></h1>
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                    <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                      ...
                      <tr>
                        ...
                        <td colspan="2" bgcolor="#FFFFFF"><span class="style21"><?php echo $row_Recordset1['FName']; ?><?php echo $row_Recordset1['FName']; ?></span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2" bgcolor="#FFFFFF"><span class="style21"><?php echo $row_Recordset1['LName']; ?></span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2"><span class="style21"><?php echo $row_Recordset1['Gender']; ?></span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2" align="left" valign="top"><span class="style21"><?php echo $row_Recordset1['SSN']; ?></span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2"><span class="style21"><?php echo $row_Recordset1['LAddress']; ?></span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td colspan="2" align="left" valign="top"><span class="style21"><?php echo $row_Recordset1['SATScore']; ?></span></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
          ...
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            <table width="100%"  border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td>&nbsp;</td>
                <td align="center" valign="middle"><span class="style18 style12"><a href="<?php echo $logoutAction ?>" class="style16">Sign Out</a></span></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td align="center" valign="middle"><span class="style17"><span class="style8"><span class="style20"><?php echo $_SESSION['MM_Username'] ?></span></span></span></td>
                <td>&nbsp;</td>
              </tr>
            </table>
