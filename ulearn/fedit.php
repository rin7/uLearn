...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form2")) {
  $updateSQL = sprintf("UPDATE faculty SET FName=%s, LName=%s, Gender=%s, SSN=%s, Address=%s, Tel=%s, EMail=%s, Password=%s WHERE FUserName=%s",
...
mysql_select_db($database_connection, $connection);
$query_Recordset1 = sprintf("SELECT * FROM faculty WHERE FUserName = '%s'", $colname_Recordset1);
                  ...
                  <form action="<?php echo $editFormAction; ?>" name="form2" method="POST">
                    <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="5%"><input name="hiddenField" type="hidden" value="<?php echo $row_Recordset1['FUserName']; ?>"></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td colspan="2"><input name="ssn" type="text" id="ssn" value="<?php echo $row_Recordset1['SSN']; ?>"></td>
                        <td class="style10"><span class="style10 style12">*Required</span></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        ...
                        <td colspan="2"><textarea name="paddress" id="paddress"><?php echo $row_Recordset1['Address']; ?></textarea></td>
                      ...
                      <tr>
                        ...
                        <td width="35%"><input name="Submit" type="submit" value="Submit"></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                    </table>
