        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style3">Help &amp; FAQ: </h1>
                  <p align="justify"> APTECH School automate the Student Information System. They have named as &ldquo;ULearn&rdquo; program, this is the new way to learn, if you want to be a member please and register from anywhere just conect to our website with your computer and see the schedule submit edit and find out more information about any course.Now you can edit your profile or select course and so on. </p>
                  <h1 class="style8">&nbsp;</h1>
