...
if (isset($_POST['username'])) {
  ...
  $MM_redirectLoginSuccess = "fhome.php";
  $MM_redirectLoginFailed = "indexf2.php";
  $MM_redirecttoReferrer = false;
  mysql_select_db($database_connection, $connection);
  	
  $LoginRS__query=sprintf("SELECT FUserName, Password, authorization FROM faculty WHERE FUserName='%s' AND Password='%s'",
  ...
  if ($loginFoundUser) {
    ...
    $loginStrGroup  = mysql_result($LoginRS,0,'authorization');
...
.style2 {color: #A0BFD0}
.style3 {color: #658393; }
.style10 {color: #CCCCCC; font-size: 14px; }
        ...
        <tr> 
          <td align="right" valign="top"><img src="images/midcurve.gif" width="192" height="17"><br> 
            <table width="460" border="0" cellspacing="0">
              <tr> 
                <td width="461" valign="top"> <h1 class="style3 style11">Faculty Login: </h1>
                    <form name="form2" method="POST" action="<?php echo $loginFormAction; ?>">
                    <table width="100%"  border="0" cellspacing="1" cellpadding="1">
                      <tr>
                        <td width="2%">&nbsp;</td>
                        <td width="20%" align="right"><span class="style13">User Name: </span></td>
                        <td width="35%" colspan="2"><input name="username" type="text" id="username"></td>
                        <td width="43%">&nbsp;</td>
                      </tr>
                      <tr>
                        <td height="25">&nbsp;</td>
                        <td align="right"><span class="style13">Password</span>:</td>
                      ...
                      <tr>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                        <td><input name="Submit" type="submit" onClick="MM_validateForm('username','','R','password','','R');return document.MM_returnValue" value="Sign In"></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
          ...
          <td width="191" align="center" valign="top" background="images/pixi_greyblue.gif" class="sidetable"> 
            ...
            <table width="100%"  border="0" cellspacing="1" cellpadding="1">
              ...
              <tr>
                <td>&nbsp;</td>
                <td colspan="2" class="style10"><div align="justify" class="style15"></div></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
